...
// Close mobile menu when clicking on a link - UPDATED
...
window.addEventListener('scroll', () => {
    let current = '';
     const isMobile = window.innerWidth <= 768;
    const offset = isMobile ? 150 : 200; // Adjust offset for mobile
...
const fadeElements = document.querySelectorAll('.skill-card, .project-card, .about-text, .contact-item');
